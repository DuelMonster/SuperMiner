...
public class BlockPos extends Vec3i
{
    ...
    private static final int NUM_X_BITS() { return 1 + calculateLogBaseTwo(roundUpToPowerOfTwo(30000000)); }
    private static final int NUM_Z_BITS() { return NUM_X_BITS(); }
    private static final int NUM_Y_BITS() { return 64 - NUM_X_BITS() - NUM_Z_BITS(); }
    private static final int Y_SHIFT() { return  0 + NUM_Z_BITS(); }
    private static final int X_SHIFT() { return  Y_SHIFT() + NUM_Y_BITS(); }
    private static final long X_MASK() { return  (1L << NUM_X_BITS()) - 1L; }
    private static final long Y_MASK() { return  (1L << NUM_Y_BITS()) - 1L; }
    private static final long Z_MASK() { return  (1L << NUM_Z_BITS()) - 1L; }
