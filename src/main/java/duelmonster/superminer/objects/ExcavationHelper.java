					...
					if (workingPos != null && !world.isAirBlock(workingPos.getX(), workingPos.getY(), workingPos.getZ())) {
						...
						if (this.bMineVeins() && Globals.isIdInList(block, Veinator.myGlobals.lBlockIDs)) {
							...
							if (!world.isAirBlock(workingPos.getX(), workingPos.getY(), workingPos.getZ()))
								player.theItemInWorldManager.tryHarvestBlock(workingPos.getX(), workingPos.getY(), workingPos.getZ());
						}
...
//				AxisAlignedBB.getBoundingBox(	oInitialPos.getX(), oInitialPos.getY(), oInitialPos.getZ(), 
...
//		Globals.stackItems(	world, player, 
//				AxisAlignedBB.getBoundingBox(	(oPacket.sideHit == EnumFacing.NORTH || oPacket.sideHit == EnumFacing.SOUTH 
