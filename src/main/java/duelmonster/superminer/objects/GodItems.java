...
public class GodItems {
	...
	public static void GiveGodTools(EntityPlayer player) {
		...
		oItemStack.addEnchantment(Enchantments.fireAspect, 2);
		...
		oItemStack.stackSize = 1;
		oItemStack.addEnchantment(Enchantments.efficiency, 5); // Six too fast...
		oItemStack.addEnchantment(Enchantments.silkTouch, 1);
		...
		oItemStack.addEnchantment(Enchantments.fireProtection, 10);
		oItemStack.addEnchantment(Enchantments.respiration, 10);
		oItemStack.addEnchantment(Enchantments.aquaAffinity, 1);
		...
		oItemStack.addEnchantment(Enchantments.protection, 10);
		oItemStack.addEnchantment(Enchantments.fireProtection, 10);
		oItemStack.addEnchantment(Enchantments.featherFalling, 10);
		oItemStack.addEnchantment(Enchantments.depthStrider, 10);
		...
		oItemStack.stackSize = 1;
		oItemStack.addEnchantment(Enchantments.luckOfTheSea, 100); // 61 = Luck of the Sea
