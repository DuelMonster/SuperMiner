...
public class GodItems {
	...
	public static void GiveGodTools(EntityPlayer player) {
		...
		oItemStack.addEnchantment(Enchantment.depthStrider, 10);
		...
		oItemStack.stackSize = 1;
		oItemStack.addEnchantment(Enchantment.luckOfTheSea, 100); // 61 = Luck of the Sea
		oItemStack.addEnchantment(Enchantment.lure, 8); // 62 = Lure
