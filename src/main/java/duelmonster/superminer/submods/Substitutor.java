...
public class Substitutor {
	...
	private void SubstitueTool(World world, BlockPos oPos) {
		try {
			...
			/*
			 * if (SettingsSubstitutor.bIgnoreIfValidTool && mc.thePlayer.getHeldItemMainhand() != null &&
			 * mc.thePlayer.getHeldItemMainhand().canHarvestBlock(world.getBlockState(oPos))) return;
			 */
