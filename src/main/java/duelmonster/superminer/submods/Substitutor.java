...
public class Substitutor {
	...
	private boolean determineTool(ItemStack CurrentTool, ItemStack CompareTool, World world, BlockPos oPos) {
		...
		if (SettingsSubstitutor.bFavourSilkTouch) {
			...
			boolean currentToolHasSilkTouch = EnchantmentHelper.getEnchantmentLevel(Enchantments.silkTouch, CurrentTool) > 0;
			boolean compareToolHasSilkTouch = EnchantmentHelper.getEnchantmentLevel(Enchantments.silkTouch, CompareTool) > 0;
...
//		else if (currentToolDamageable && !compareToolDamageable) return true;
	...
	private boolean determineWeapon(ItemStack CurrentWeapon, ItemStack CompareWeapon, EntityLivingBase entity) {
		...
		int currentWeaponFireAspectLevel = EnchantmentHelper.getEnchantmentLevel(Enchantments.fireAspect, CurrentWeapon);
		...
		int compareWeaponFireAspectLevel = EnchantmentHelper.getEnchantmentLevel(Enchantments.fireAspect, CompareWeapon);
