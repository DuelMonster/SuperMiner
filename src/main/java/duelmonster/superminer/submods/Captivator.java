...
@Mod(modid = Captivator.MODID, name = Captivator.MODName, version = SuperMiner_Core.VERSION, acceptedMinecraftVersions = SuperMiner_Core.MCVERSION)
public class Captivator {
	...
	public void tickEvent(TickEvent.ClientTickEvent event) {
		if (!PlayerEvents.IsPlayerInWorld() || !SettingsCaptivator.bEnabled || !TickEvent.Phase.END.equals(event.phase) || Excavator.isExcavating() || Shaftanator.isExcavating() || Veinator.isExcavating()) return;
	...
	public void onServerPacket(FMLNetworkEvent.ServerCustomPacketEvent event) {
		...
		if (iPacketID == PacketIDs.Settings_Captivator.value()) SettingsCaptivator.readPacketData(payLoad);
